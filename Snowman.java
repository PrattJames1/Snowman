/******************************************************************
	...
	Snowman.java				Author: James Pratt

	Uses JavaFX to create a snowman.

******************************************************************/

//************************************************************************
//  SnowmanFX.java       Author: Lewis/Loftus
//
...
public class Snowman extends Application
{
    ...
    {      
        ...
        Ellipse mouth = new Ellipse(80, 80, 20, 5);

        Circle topButton = new Circle(80, 100, 6);
        topButton.setFill(Color.RED);
        Circle middleButton = new Circle(80, 120, 6);
        ...
        Group snowman = new Group(base, middle, head, leftEye, rightEye,
            mouth, topButton, middleButton, bottomButton, leftArm, rightArm,
            hat);
        snowman.setTranslateX(190);
        ...
        Group root = new Group(text, ground, sun, snowman);
